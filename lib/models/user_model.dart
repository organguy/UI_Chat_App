class User{
  ...
  const User({required this.id, required this.name, required this.surname, required this.imageUrl});
  ...
  static const List<User> users = [
    User(
        ...
        name: 'John',
        surname: 'Whitaker',
        imageUrl: 'https://images.unsplash.com/photo-1657299143322-934f44698807?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1287&q=80',
    ),
    User(
      id: '2',
      name: 'Alex',
